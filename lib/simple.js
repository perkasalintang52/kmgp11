...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Created By Anggan Official', body: wm, sourceUrl: 'https://chat.whatsapp.com/Bpj3rzyS8D25VAUeDgo2El', thumbnail: data }}, options })
    }
